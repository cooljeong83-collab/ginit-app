...
export const voteCandidatesFormStyles = StyleSheet.create({
  ...
  timeManageListScroll: {
    maxHeight: 210,
  },
  timeManageListContent: {
    gap: 8,
    paddingHorizontal: 4,
    paddingBottom: 2,
  },
