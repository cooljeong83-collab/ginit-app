...
const styles = StyleSheet.create({
  ...
  h1: { fontSize: 20, fontWeight: '600', color: '#0f172a', letterSpacing: -0.3 },
  ...
  termsTitle: { fontSize: 16, fontWeight: '600', color: '#0f172a' },
  ...
  agreeText: { fontSize: 15, fontWeight: '600', color: '#fff' },
});
